from parrotfactory import ParrotFactory, ParrotType
...
class TestParrot:
    ...
    def test_cry_of_european_parrot(self):
        parrot = ParrotFactory.create(ParrotType.EUROPEAN, 0, 0, False)
    ...
    def test_cry_of_african_parrot(self):
        parrot = ParrotFactory.create(ParrotType.AFRICAN, 1, 0, False)
    ...
    def test_cry_norwegian_blue_parrot_high_voltage(self):
        parrot = ParrotFactory.create(ParrotType.NORWEGIAN_BLUE, 0, 4, False)
        assert parrot.cry() == "Bzzzzzz"

    def test_cry_norwegian_blue_parrot_no_voltage(self):
